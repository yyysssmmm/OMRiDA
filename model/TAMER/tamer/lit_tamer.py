...
class LitTAMER(pl.LightningModule):
    ...
    def test_epoch_end(self, test_outputs) -> None:
        ...
        leq1_rate = leq1_correct / total if total > 0 else 0.0
        leq2_rate = leq2_correct / total if total > 0 else 0.0
        print(f"Validation 1-error Rate: {leq1_rate:.12f}")
        print(f"Validation 2-error Rate: {leq2_rate:.12f}")
