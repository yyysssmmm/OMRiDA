...
# 경로 설정
base_dir = "C:/Users/sophi/OneDrive/바탕 화면/Folder/2025 HYU/인공지능프로젝트/data/test/crohme/pme"
input_dir = "C:/Users/sophi/OneDrive/바탕 화면/Folder/2025 HYU/인공지능프로젝트/data/test/crohme/pme/2014"
output_dir = "C:/Users/sophi/Documents/pme_2014"
...
caption_path = os.path.join(base_dir, "caption_2014.txt")
...
for img_name in tqdm(image_names, desc="Resizing images"):
    ...
    output_path = os.path.normpath(os.path.join(output_dir, name_wo_ext + ".png"))
    if not imwrite_unicode(output_path, resized):
